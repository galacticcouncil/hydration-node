...
fn test_fees_update_in_multi_blocks() {
	...
	Hydra::execute_with(|| {
		...
		assert_eq!(hdx_fee.asset_fee, Permill::from_float(0.04372));
		...
		assert_eq!(
			dai_final_fees,
			(Permill::from_float(0.003547), Permill::from_float(0.0005))
		);
		assert_eq!(
			dot_final_fees,
			(Permill::from_float(0.0015), Permill::from_float(0.001723))
		);
		assert_eq!(
			eth_final_fees,
			(Permill::from_float(0.0015), Permill::from_float(0.0025))
		);
		assert_eq!(btc_final_fees, (Permill::from_float(0.0015), Permill::from_parts(798)));
		...
		assert_eq!(
			dai_final_fees,
			(Permill::from_float(0.003682), Permill::from_float(0.0005))
		);
		...
		assert_eq!(
			dai_final_fees,
			(Permill::from_float(0.003799), Permill::from_float(0.0005))
		);
		...
		assert_eq!(
			dai_final_fees,
			(Permill::from_float(0.003899), Permill::from_float(0.0005))
		);
		...
		assert_eq!(
			dai_final_fees,
			(Permill::from_float(0.004114), Permill::from_float(0.0005))
		);
	});
}
...
fn test_fees_update_after_selling_lrna_in_multi_blocks() {
	...
	Hydra::execute_with(|| {
		...
		assert_eq!(
			(dai_fee.0, dai_fee.1),
			(Permill::from_float(0.003858), Permill::from_float(0.0005))
		);
	});
}
...
fn test_fees_update_after_buying_with_lrna_in_multi_blocks() {
	...
	Hydra::execute_with(|| {
		...
		assert_eq!(
			(dai_fee.0, dai_fee.1),
			(Permill::from_float(0.00369), Permill::from_float(0.0005))
		);
	});
}
