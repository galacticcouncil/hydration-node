	...
	match &cli.subcommand {
		...
		Some(Subcommand::TryRuntime(cmd)) => {
			...
			runner.async_run(|config| {
				...
				Ok((cmd.run::<Block, ExtendedHostFunctions<sp_io::SubstrateHostFunctions, <service::HydraDXExecutorDispatch as NativeExecutionDispatch>::ExtendHostFunctions>>(), task_manager))
			})
		}
