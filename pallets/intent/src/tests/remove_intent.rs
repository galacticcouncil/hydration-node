...
fn should_work_when_canceled_by_owner() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			//Act
			assert_ok!(IntentPallet::remove_intent(RuntimeOrigin::signed(owner), id));
...
fn should_not_work_when_intent_doesnt_exist() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			//Act & Assert;
			assert_noop!(
				IntentPallet::remove_intent(RuntimeOrigin::signed(owner), id),
...
fn should_not_work_when_canceled_non_owner() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			//Act & Assert;
			assert_noop!(
				IntentPallet::remove_intent(RuntimeOrigin::signed(non_owner), id),
...
fn should_not_work_when_origin_is_none() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			//Act & Assert;
			assert_noop!(IntentPallet::remove_intent(RuntimeOrigin::none(), id), BadOrigin);
		});
}
