...
fn set_location_should_work_when_location_was_not_set_yet() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			//Act
			assert_ok!(<Registry as Mutate<AssetLocation>>::set_location(
				asset_id,
				location.clone()
			));
...
fn set_location_should_not_work_when_location_was_not() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			//Act
			assert_noop!(
				<Registry as Mutate<AssetLocation>>::set_location(asset_id, location),
...
fn set_location_should_not_work_when_asset_does_not_exists() {
	...
	ExtBuilder::default().build().execute_with(|| {
		...
		//Act
		assert_noop!(
			<Registry as Mutate<AssetLocation>>::set_location(non_existing_id, location),
