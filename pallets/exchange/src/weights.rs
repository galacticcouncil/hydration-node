...
//! DATE: 2021-02-10, STEPS: [5, ], REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	fn known_overhead_for_on_finalize() -> Weight {
		(14_002_000 as Weight).saturating_add(T::DbWeight::get().reads(1 as Weight))
	}
	fn sell_intention() -> Weight {
	...
	fn on_finalize(t: u32) -> Weight {
		(11_618_000 as Weight)
			...
			.saturating_add((154_957_000 as Weight).saturating_mul(t as Weight))
	...
	fn on_finalize_buys_no_matches(t: u32) -> Weight {
		(25_261_000 as Weight)
			...
			.saturating_add((172_895_000 as Weight).saturating_mul(t as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(t as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(t as Weight)))
	...
	fn on_finalize_sells_no_matches(t: u32) -> Weight {
		(19_982_000 as Weight)
			...
			.saturating_add((150_891_000 as Weight).saturating_mul(t as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(t as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(t as Weight)))
	...
	fn sell_extrinsic() -> Weight {
		(162_686_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn on_finalize_for_one_sell_extrinsic() -> Weight {
		(215_629_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
	fn buy_extrinsic() -> Weight {
		(162_170_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn on_finalize_for_one_buy_extrinsic() -> Weight {
		(238_021_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
}
...
impl WeightInfo for () {
	fn known_overhead_for_on_finalize() -> Weight {
		(14_002_000 as Weight).saturating_add(RocksDbWeight::get().reads(1 as Weight))
	}
	fn sell_intention() -> Weight {
		(84_160_000 as Weight)
