...
impl<T: frame_system::Config> WeightInfo for BasiliskWeight<T> {
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(3_271_000, 7406).saturating_add(T::DbWeight::get().reads(1))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(19_258_000, 6294).saturating_add(T::DbWeight::get().reads(2))
	}
}
...
impl WeightInfo for () {
	...
	fn on_finalize_no_entry() -> Weight {
		...
		//  Estimated: `7406`
		// Minimum execution time: 3_165_000 picoseconds.
		Weight::from_parts(3_271_000, 7406).saturating_add(RocksDbWeight::get().reads(1))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(5921), added: 6416, mode: `MaxEncodedLen`)
	/// Storage: `EmaOracle::Oracles` (r:117 w:117)
	...
	fn get_entry() -> Weight {
		...
		//  Estimated: `6294`
		// Minimum execution time: 18_991_000 picoseconds.
		Weight::from_parts(19_258_000, 6294).saturating_add(RocksDbWeight::get().reads(2))
	}
}
