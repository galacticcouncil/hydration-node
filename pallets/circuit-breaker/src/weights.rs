...
impl WeightInfo for () {
	...
	fn set_trade_volume_limit() -> Weight {
		...
		Weight::from_parts(12_601_000, 0).saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn set_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(12_660_000, 0).saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn set_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(12_729_000, 0).saturating_add(RocksDbWeight::get().writes(1_u64))
	}
