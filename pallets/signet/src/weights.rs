...
impl WeightInfo for () {
	...
	fn respond(r: u32) -> Weight {
		...
		Weight::from_parts(10_000_000, 0).saturating_add(Weight::from_parts(1_000_000, 0).saturating_mul(r.into()))
	}

	fn respond_error(e: u32) -> Weight {
		// Base weight + per-error weight
		Weight::from_parts(10_000_000, 0).saturating_add(Weight::from_parts(500_000, 0).saturating_mul(e.into()))
	}
