...
#[test]
fn spot_price_calculation_should_work_when_asset_in_is_share() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			let sell_amount = 30 * ONE;
			let total_issuance = Tokens::total_issuance(pool_id);
			let initial_issuance = 200000100000000000000;
...
fn spot_price_calculation_should_work_when_asset_out_is_share() {
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			let expected = 9997637343078345702;
