...
pub const BUY_DCA_FEE_IN_NATIVE: Balance = 2782980000;
pub const BUY_DCA_FEE_IN_DAI: Balance = 2449022400;
pub const SELL_DCA_FEE_IN_NATIVE: Balance = 2774704000;
pub const SELL_DCA_FEE_IN_DAI: Balance = 2441739520;
