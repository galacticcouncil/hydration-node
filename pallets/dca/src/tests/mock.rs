...
pub const BUY_DCA_FEE_IN_NATIVE: Balance = 1331738000;
pub const BUY_DCA_FEE_IN_DAI: Balance = 1171929440;
pub const SELL_DCA_FEE_IN_NATIVE: Balance = 1333782000;
pub const SELL_DCA_FEE_IN_DAI: Balance = 1173728160;
