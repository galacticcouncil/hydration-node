...
pub const BUY_DCA_FEE_IN_NATIVE: Balance = 1345122000;
pub const BUY_DCA_FEE_IN_DAI: Balance = 1183707360;
pub const SELL_DCA_FEE_IN_NATIVE: Balance = 1344450000;
pub const SELL_DCA_FEE_IN_DAI: Balance = 1183116000;
