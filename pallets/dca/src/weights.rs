...
impl WeightInfo for () {
    ...
    fn on_initialize_with_buy_trade() -> Weight {
        // Minimum execution time: 202_152 nanoseconds.
        Weight::from_ref_time(205_108_000 as u64)            .saturating_add(RocksDbWeight::get().reads(17 as u64))
    ...
    fn on_initialize_with_sell_trade() -> Weight {
        // Minimum execution time: 200_514 nanoseconds.
        Weight::from_ref_time(204_215_000 as u64)            .saturating_add(RocksDbWeight::get().reads(17 as u64))
            .saturating_add(RocksDbWeight::get().writes(7 as u64))
    }
	// Storage: DCA ScheduleIdsPerBlock (r:1 w:0)
	// Proof: DCA ScheduleIdsPerBlock (max_values: None, max_size: Some(101), added: 2576, mode: MaxEncodedLen)
    ...
    fn schedule() -> Weight {
        // Minimum execution time: 133_110 nanoseconds.
        Weight::from_ref_time(134_484_000 as u64)            .saturating_add(RocksDbWeight::get().reads(14 as u64))
    ...
    fn terminate() -> Weight {
        // Minimum execution time: 74_610 nanoseconds.
        Weight::from_ref_time(75_402_000 as u64)            .saturating_add(RocksDbWeight::get().reads(5 as u64))
            .saturating_add(RocksDbWeight::get().writes(7 as u64))
    }
}
