...
//! DATE: 2023-05-30, STEPS: 5, REPEAT: 50, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	...
	fn on_initialize_with_buy_trade() -> Weight {
		// Minimum execution time: 404_689 nanoseconds.
		Weight::from_ref_time(407_980_000 as u64)
	...
	// Proof: DCA RetriesOnError (max_values: None, max_size: Some(24), added: 2499, mode: MaxEncodedLen)
	fn on_initialize_with_sell_trade() -> Weight {
		// Minimum execution time: 397_812 nanoseconds.
		Weight::from_ref_time(399_704_000 as u64)
			.saturating_add(T::DbWeight::get().reads(27 as u64))
			.saturating_add(T::DbWeight::get().writes(17 as u64))
	}
	...
	fn on_initialize_with_empty_block() -> Weight {
		...
		Weight::from_ref_time(6_215_000 as u64).saturating_add(T::DbWeight::get().reads(1 as u64))
	}
	...
	// Proof: DCA RemainingAmounts (max_values: None, max_size: Some(36), added: 2511, mode: MaxEncodedLen)
	fn schedule() -> Weight {
		// Minimum execution time: 111_170 nanoseconds.
		Weight::from_ref_time(112_145_000 as u64)
	...
	// Proof: DCA ScheduleOwnership (max_values: None, max_size: Some(60), added: 2535, mode: MaxEncodedLen)
	fn terminate() -> Weight {
		// Minimum execution time: 59_517 nanoseconds.
		Weight::from_ref_time(60_204_000 as u64)
...
impl WeightInfo for () {
	...
	fn on_initialize_with_buy_trade() -> Weight {
		// Minimum execution time: 404_689 nanoseconds.
		Weight::from_ref_time(407_980_000)
	...
	fn on_initialize_with_sell_trade() -> Weight {
		// Minimum execution time: 397_812 nanoseconds.
		Weight::from_ref_time(399_704_000)
			.saturating_add(RocksDbWeight::get().reads(27))
			.saturating_add(RocksDbWeight::get().writes(17))
	}
	// Storage: DCA ScheduleIdsPerBlock (r:1 w:0)
	...
	fn on_initialize_with_empty_block() -> Weight {
		// Minimum execution time: 6_029 nanoseconds.
		Weight::from_ref_time(6_215_000).saturating_add(RocksDbWeight::get().reads(1))
	}
	// Storage: Omnipool Assets (r:2 w:0)
	// Proof: Omnipool Assets (max_values: None, max_size: Some(85), added: 2560, mode: MaxEncodedLen)
	// Storage: Tokens Accounts (r:1 w:0)
	...
	fn schedule() -> Weight {
		// Minimum execution time: 111_170 nanoseconds.
		Weight::from_ref_time(112_145_000)
	...
	fn terminate() -> Weight {
		// Minimum execution time: 59_517 nanoseconds.
		Weight::from_ref_time(60_204_000)
