...
/// `s = TotalStHdx`, `t = TotalLocked + gigapot_balance`.
///
...
/// `t = TotalLocked + gigapot_balance` and `s = TotalStHdx` BEFORE the
/// unstake.
///
...
mod tests {
	...
	#[test]
	fn st_input_bootstrap_is_one_to_one() {
	...
	#[test]
	fn st_input_with_pot_returns_fewer_st() {
	...
	#[test]
	fn st_input_uses_u256_for_large_inputs() {
