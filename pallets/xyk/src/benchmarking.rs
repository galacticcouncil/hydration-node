...
benchmarks! {
	...
	add_liquidity {
		...
		XYK::<T>::create_pool(RawOrigin::Signed(maker.clone()).into(), asset_a,asset_b, 1_000_000_000, Price::from_num(1))?;
	...
	remove_liquidity {
		...
		XYK::<T>::create_pool(RawOrigin::Signed(maker.clone()).into(), 1, 2, 10_000_000_000, Price::from_num(2))?;
	...
	sell {
		...
		XYK::<T>::create_pool(RawOrigin::Signed(maker.clone()).into(), asset_a, asset_b, 1 * 1_000_000_000_000, Price::from_num(3))?;
