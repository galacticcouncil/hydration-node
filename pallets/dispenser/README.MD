...
- On‑chain:
  ...
  - It then uses `pallet_signet::sign_respond` to request an ECDSA signature from SigNet.
...
2. The pallet:
   ...
   - Builds EIP‑1559 transaction bytes and calls `pallet_signet::sign_respond`.
