...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		// Minimum execution time: 26_295 nanoseconds.
	...
	// Proof: MultiTransactionPayment AcceptedCurrencies (max_values: None, max_size: Some(28), added: 2503, mode: MaxEncodedLen)
	fn remove_currency() -> Weight {
		// Minimum execution time: 26_763 nanoseconds.
	...
	fn set_currency() -> Weight {
		...
		Weight::from_ref_time(33_226_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	...
	fn get_oracle_price() -> Weight {
		// Minimum execution time: 88_418 nanoseconds.
		Weight::from_ref_time(89_129_000 as u64).saturating_add(T::DbWeight::get().reads(11 as u64))
	}
}
...
impl WeightInfo for () {
	...
	fn add_currency() -> Weight {
		// Minimum execution time: 26_295 nanoseconds.
		Weight::from_ref_time(26_689_000)
	...
	fn remove_currency() -> Weight {
		// Minimum execution time: 26_763 nanoseconds.
		Weight::from_ref_time(27_349_000)
			.saturating_add(RocksDbWeight::get().reads(1))
			.saturating_add(RocksDbWeight::get().writes(1))
	}
	// Storage: MultiTransactionPayment AcceptedCurrencies (r:1 w:0)
	...
	fn set_currency() -> Weight {
		// Minimum execution time: 32_888 nanoseconds.
		Weight::from_ref_time(33_226_000)
			.saturating_add(RocksDbWeight::get().reads(1))
			.saturating_add(RocksDbWeight::get().writes(1))
	}
	// Storage: Router Routes (r:1 w:0)
	...
	fn get_oracle_price() -> Weight {
		// Minimum execution time: 88_418 nanoseconds.
		Weight::from_ref_time(89_129_000).saturating_add(RocksDbWeight::get().reads(11))
	}
}
