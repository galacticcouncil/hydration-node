...
impl WeightInfo for () {
	...
	fn calculate_buy() -> Weight {
		...
		Weight::from_parts(90_543_000, 6156).saturating_add(RocksDbWeight::get().reads(3_u64))
	}
	/// Storage: `LBP::PoolData` (r:1 w:0)
	/// Proof: `LBP::PoolData` (`max_values`: None, `max_size`: Some(163), added: 2638, mode: `MaxEncodedLen`)
	/// Storage: `Tokens::Locks` (r:1 w:0)
	...
	fn calculate_spot_price_with_fee() -> Weight {
		...
		Weight::from_parts(24_702_000, 6156).saturating_add(RocksDbWeight::get().reads(4_u64))
	}
}
