...
use frame_support::{
	...
	traits::{Currency as PalletCurrency, EnsureOrigin, EnsureOneOf, Get, InstanceFilter, PrivilegeCmp, EqualPrivilegeOnly, Everything, OnUnbalanced, Imbalance, U128CurrencyToVote},
	weights::{
