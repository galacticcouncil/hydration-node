...
use frame_support::traits::{
	fungible, fungibles, Currency, ExistenceRequirement, Get, SignedImbalance, WithdrawReasons,
};
...
pub struct FeeAssetCurrencyAdapter<T, AccountId, Inspector, GetCurrencyId, EC, C>(
	sp_std::marker::PhantomData<(T, AccountId, Inspector, GetCurrencyId, EC, C)>,
);

impl<T, AccountId, Inspector, GetCurrencyId, EC, C> fungible::Inspect<AccountId>
	for FeeAssetCurrencyAdapter<T, AccountId, Inspector, GetCurrencyId, EC, C>
where
...
impl<T, AccountId, Inspector, GetCurrencyId, EC, C> frame_support::traits::tokens::currency::Currency<AccountId>
	for FeeAssetCurrencyAdapter<T, AccountId, Inspector, GetCurrencyId, EC, C>
where
