...
parameter_types! {
	...
	pub const DefaultEmergencyAdminAccount: AccountId = AccountId::new(hex!("aa7e0000000000000000000000000000000aa7e1000000000000000000000000"));
}
...
impl pallet_dispatcher::Config for Runtime {
	...
	type DefaultEmergencyAdminAccount = DefaultEmergencyAdminAccount;
