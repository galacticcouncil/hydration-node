...
/// Weights for `cumulus_pallet_parachain_system` using the HydraDX node and recommended hardware.
pub struct HydraWeight<T>(PhantomData<T>);
impl<T: frame_system::Config> cumulus_pallet_parachain_system::WeightInfo for HydraWeight<T> {
	...
	fn enqueue_inbound_downward_messages(n: u32, ) -> Weight {
		...
		Weight::from_parts(92_474_905, 3517)
			// Standard Error: 55_782
			.saturating_add(Weight::from_parts(283_097_718, 0).saturating_mul(n.into()))
