...
//! DATE: 2025-09-19, STEPS: `50`, REPEAT: `20`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_duster::WeightInfo for HydraWeight<T> {
	...
	fn dust_account() -> Weight {
		...
		//  Measured:  `7192`
		//  Estimated: `13132`
		// Minimum execution time: 361_165_000 picoseconds.
		Weight::from_parts(362_568_000, 13132)
	...
	fn remove_nondustable_account() -> Weight {
		...
		Weight::from_parts(28_375_000, 3513)
