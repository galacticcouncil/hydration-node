...
impl<T: frame_system::Config> ismp_parachain::WeightInfo for HydraWeight<T> {
	...
	fn add_parachain(n: u32, ) -> Weight {
		...
		Weight::from_parts(8_463_089, 0)
			// Standard Error: 2_015
			.saturating_add(Weight::from_parts(2_752_035, 0).saturating_mul(n.into()))
	...
	fn remove_parachain(n: u32, ) -> Weight {
		...
		Weight::from_parts(14_132_379, 0)
			// Standard Error: 200
			.saturating_add(Weight::from_parts(8_338, 0).saturating_mul(n.into()))
	...
	fn update_parachain_consensus() -> Weight {
		...
		//  Measured:  `1086`
		//  Estimated: `5964`
		// Minimum execution time: 173_173_000 picoseconds.
		Weight::from_parts(194_749_000, 5964)
