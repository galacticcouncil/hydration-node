...
impl<T: frame_system::Config> ismp_parachain::WeightInfo for HydraWeight<T> {
	...
	fn add_parachain(n: u32, ) -> Weight {
		...
		Weight::from_parts(7_866_180, 0)
			// Standard Error: 2_005
			.saturating_add(Weight::from_parts(2_682_166, 0).saturating_mul(n.into()))
	...
	fn remove_parachain(n: u32, ) -> Weight {
		...
		Weight::from_parts(13_320_808, 0)
			// Standard Error: 231
			.saturating_add(Weight::from_parts(8_496, 0).saturating_mul(n.into()))
	...
	fn update_parachain_consensus() -> Weight {
		...
		//  Measured:  `1086`
		//  Estimated: `5964`
		// Minimum execution time: 163_709_000 picoseconds.
		Weight::from_parts(203_975_000, 5964)
