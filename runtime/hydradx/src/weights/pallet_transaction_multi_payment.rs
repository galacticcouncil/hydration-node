...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(25_954_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(25_358_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(36_210_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `4996`
		//  Estimated: `49032`
		// Minimum execution time: 155_605_000 picoseconds.
		Weight::from_parts(156_489_000, 49032)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(28_839_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4359`
		//  Estimated: `11322`
		// Minimum execution time: 291_751_000 picoseconds.
		Weight::from_parts(294_143_000, 11322)
