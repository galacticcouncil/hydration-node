...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(28_019_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(27_699_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(39_697_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `4996`
		//  Estimated: `49032`
		// Minimum execution time: 157_635_000 picoseconds.
		Weight::from_parts(159_804_000, 49032)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(30_847_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4319`
		//  Estimated: `11322`
		// Minimum execution time: 297_424_000 picoseconds.
		Weight::from_parts(297_985_000, 11322)
