...
// --output
// runtime/hydradx/src/weights/pallet_transaction_multi_payment.rs
// --quiet
...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(27_064_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(26_621_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(30_192_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4330`
		//  Estimated: `11322`
		// Minimum execution time: 318_456_000 picoseconds.
		Weight::from_parts(320_214_000, 11322)
