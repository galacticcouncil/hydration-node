...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(26_995_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(27_168_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(38_927_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `4690`
		//  Estimated: `48726`
		// Minimum execution time: 156_459_000 picoseconds.
		Weight::from_parts(157_801_000, 48726)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(30_239_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4267`
		//  Estimated: `11322`
		// Minimum execution time: 293_041_000 picoseconds.
		Weight::from_parts(295_137_000, 11322)
