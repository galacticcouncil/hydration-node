...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(27_918_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(27_805_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		Weight::from_parts(39_206_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `4996`
		//  Estimated: `49032`
		// Minimum execution time: 159_146_000 picoseconds.
		Weight::from_parts(160_772_000, 49032)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(30_846_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4356`
		//  Estimated: `11322`
		// Minimum execution time: 293_925_000 picoseconds.
		Weight::from_parts(296_634_000, 11322)
