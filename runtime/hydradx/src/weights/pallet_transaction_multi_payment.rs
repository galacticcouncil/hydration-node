...
impl<T: frame_system::Config> pallet_transaction_multi_payment::WeightInfo for HydraWeight<T> {
	...
	fn add_currency() -> Weight {
		...
		Weight::from_parts(27_862_000, 3493)
	...
	fn remove_currency() -> Weight {
		...
		Weight::from_parts(27_605_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_currency() -> Weight {
		...
		//  Measured:  `1305`
		//  Estimated: `3493`
		// Minimum execution time: 38_296_000 picoseconds.
		Weight::from_parts(38_721_000, 3493)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_oracle_price() -> Weight {
		...
		//  Measured:  `3221`
		//  Estimated: `27510`
		// Minimum execution time: 103_931_000 picoseconds.
		Weight::from_parts(104_701_000, 27510)
	...
	fn reset_payment_currency() -> Weight {
		...
		Weight::from_parts(30_710_000, 4087)
	...
	fn withdraw_fee() -> Weight {
		...
		//  Measured:  `4234`
		//  Estimated: `11322`
		// Minimum execution time: 285_117_000 picoseconds.
		Weight::from_parts(286_941_000, 11322)
