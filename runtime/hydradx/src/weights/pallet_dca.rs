...
impl<T: frame_system::Config> pallet_dca::WeightInfo for HydraWeight<T> {
	...
	/// Proof: `DCA::ScheduleIdsPerBlock` (`max_values`: None, `max_size`: Some(29), added: 2504, mode: `MaxEncodedLen`)
	/// Storage: `DCA::Schedules` (r:1 w:0)
	/// Proof: `DCA::Schedules` (`max_values`: None, `max_size`: Some(243), added: 2718, mode: `MaxEncodedLen`)
	/// Storage: `DCA::ScheduleExtraGas` (r:1 w:0)
	/// Proof: `DCA::ScheduleExtraGas` (`max_values`: None, `max_size`: Some(28), added: 2503, mode: `MaxEncodedLen`)
	...
	fn on_initialize_with_buy_trade() -> Weight {
		...
		//  Measured:  `10201`
		//  Estimated: `31038`
		// Minimum execution time: 252_723_000 picoseconds.
		Weight::from_parts(253_612_000, 31038)
	...
	fn on_initialize_with_buy_trade_with_insufficient_fee_asset() -> Weight {
		...
		//  Measured:  `15951`
		//  Estimated: `31038`
		// Minimum execution time: 457_828_000 picoseconds.
		Weight::from_parts(461_892_000, 31038)
	...
	fn on_initialize_with_sell_trade() -> Weight {
		...
		//  Measured:  `9949`
		//  Estimated: `31038`
		// Minimum execution time: 255_844_000 picoseconds.
		Weight::from_parts(257_585_000, 31038)
			.saturating_add(T::DbWeight::get().reads(23_u64))
			.saturating_add(T::DbWeight::get().writes(9_u64))
	}
	/// Storage: `DCA::ScheduleIdsPerBlock` (r:12 w:2)
	...
	fn on_initialize_with_sell_trade_with_insufficient_fee_asset() -> Weight {
		...
		//  Measured:  `16035`
		//  Estimated: `31038`
		// Minimum execution time: 462_082_000 picoseconds.
		Weight::from_parts(464_054_000, 31038)
			.saturating_add(T::DbWeight::get().reads(46_u64))
			.saturating_add(T::DbWeight::get().writes(12_u64))
	}
	...
	fn on_initialize_with_empty_block() -> Weight {
		...
		Weight::from_parts(20_279_000, 3494)
	...
	fn schedule() -> Weight {
		...
		//  Measured:  `9397`
		//  Estimated: `28534`
		// Minimum execution time: 222_856_000 picoseconds.
		Weight::from_parts(225_660_000, 28534)
	...
	/// Storage: `DCA::RetriesOnError` (r:0 w:1)
	/// Proof: `DCA::RetriesOnError` (`max_values`: None, `max_size`: Some(21), added: 2496, mode: `MaxEncodedLen`)
	/// Storage: `DCA::ScheduleExtraGas` (r:0 w:1)
	/// Proof: `DCA::ScheduleExtraGas` (`max_values`: None, `max_size`: Some(28), added: 2503, mode: `MaxEncodedLen`)
	/// Storage: `DCA::ScheduleOwnership` (r:0 w:1)
	/// Proof: `DCA::ScheduleOwnership` (`max_values`: None, `max_size`: Some(60), added: 2535, mode: `MaxEncodedLen`)
	fn terminate() -> Weight {
		...
		Weight::from_parts(99_541_000, 4714)
	...
	fn unlock_reserves() -> Weight {
		...
		//  Measured:  `1992`
		//  Estimated: `4714`
		// Minimum execution time: 60_918_000 picoseconds.
		Weight::from_parts(61_643_000, 4714)
