...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for HydraWeight<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(8_281_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(9_373_001, 42428)
			// Standard Error: 1_973
			.saturating_add(Weight::from_parts(422_473, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(24_026_000, 3606)
			// Standard Error: 18
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_517_522, 42428)
			// Standard Error: 1_677
			.saturating_add(Weight::from_parts(422_550, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_551_854, 42428)
			// Standard Error: 653
			.saturating_add(Weight::from_parts(673_092, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(25_700_241, 42428)
			// Standard Error: 2_962
			.saturating_add(Weight::from_parts(462_828, 0).saturating_mul(s.into()))
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(26_336_529, 42428)
			// Standard Error: 1_335
			.saturating_add(Weight::from_parts(708_491, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_210_771, 42428)
			// Standard Error: 327
			.saturating_add(Weight::from_parts(16_260, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(32_931_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_retry_named() -> Weight {
		...
		//  Measured:  `9605`
		//  Estimated: `42428`
		// Minimum execution time: 41_782_000 picoseconds.
		Weight::from_parts(42_430_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(41_826_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}