...
impl<T: frame_system::Config> pallet_fee_processor::WeightInfo for HydraWeight<T> {
	...
	/// Storage: `FeeProcessor::HeldFees` (r:3 w:3)
	/// Proof: `FeeProcessor::HeldFees` (`max_values`: None, `max_size`: Some(64), added: 2539, mode: `MaxEncodedLen`)
	...
	fn convert() -> Weight {
		...
		//  Measured:  `13244`
		//  Estimated: `14005`
		// Minimum execution time: 788_189_000 picoseconds.
		Weight::from_parts(790_368_000, 14005)
