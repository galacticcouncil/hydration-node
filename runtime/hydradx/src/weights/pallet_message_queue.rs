...
impl<T: frame_system::Config> pallet_message_queue::WeightInfo for HydraWeight<T> {
	...
	fn ready_ring_knit() -> Weight {
		...
		Weight::from_parts(18_562_000, 6044)
	...
	fn ready_ring_unknit() -> Weight {
		...
		Weight::from_parts(17_080_000, 6044)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn service_queue_base() -> Weight {
		...
		Weight::from_parts(7_284_000, 3517)
	...
	fn service_page_base_completion() -> Weight {
		...
		Weight::from_parts(9_889_000, 137658)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `MessageQueue::Pages` (r:1 w:1)
	...
	fn service_page_base_no_completion() -> Weight {
		...
		Weight::from_parts(10_063_000, 137658)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_page_item() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 293_905_000 picoseconds.
		Weight::from_parts(296_085_000, 0)
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::ServiceHead` (r:1 w:1)
	/// Proof: `MessageQueue::ServiceHead` (`max_values`: Some(1), `max_size`: Some(5), added: 500, mode: `MaxEncodedLen`)
	...
	fn bump_service_head() -> Weight {
		...
		Weight::from_parts(11_346_000, 3517)
	...
	fn reap_page() -> Weight {
		...
		Weight::from_parts(100_872_000, 137658)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_removed() -> Weight {
		...
		//  Measured:  `134345`
		//  Estimated: `137658`
		// Minimum execution time: 132_992_000 picoseconds.
		Weight::from_parts(133_954_000, 137658)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `MessageQueue::BookStateFor` (r:1 w:1)
	...
	fn execute_overweight_page_updated() -> Weight {
		...
		//  Measured:  `134345`
		//  Estimated: `137658`
		// Minimum execution time: 209_188_000 picoseconds.
		Weight::from_parts(210_714_000, 137658)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}