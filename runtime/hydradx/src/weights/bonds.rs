...
/// Weight functions for `pallet_bonds`.
...
impl<T: frame_system::Config> pallet_bonds::WeightInfo for HydraWeight<T> {
	...
	fn issue() -> Weight {
		...
		Weight::from_parts(297_850_000, 8799)
	...
	fn redeem() -> Weight {
		...
		//  Measured:  `1744`
		//  Estimated: `8799`
		// Minimum execution time: 215_448_000 picoseconds.
		Weight::from_parts(216_795_000, 8799)
