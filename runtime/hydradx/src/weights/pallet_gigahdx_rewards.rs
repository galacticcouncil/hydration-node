...
//! Autogenerated weights for `pallet_gigahdx_rewards`
//!
...
// --output
// runtime/hydradx/src/weights/pallet_gigahdx_rewards.rs
// --quiet
...
/// Weights for `pallet_gigahdx_rewards`.
...
impl<T: frame_system::Config> pallet_gigahdx_rewards::WeightInfo for HydraWeight<T> {
	...
	/// Proof: `GigaHdxRewards::PendingRewards` (`max_values`: None, `max_size`: Some(64), added: 2539, mode: `MaxEncodedLen`)
	...
	fn claim_rewards() -> Weight {
		...
		//  Measured:  `1474`
		//  Estimated: `6196`
		// Minimum execution time: 171_242_000 picoseconds.
		Weight::from_parts(172_619_000, 6196)
