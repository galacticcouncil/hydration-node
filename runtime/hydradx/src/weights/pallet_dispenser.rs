...
impl<T: frame_system::Config> pallet_dispenser::WeightInfo for HydraWeight<T> {
	...
	fn set_config() -> Weight {
		...
		Weight::from_parts(13_637_000, 1586)
	...
	fn pause() -> Weight {
		...
		Weight::from_parts(17_239_000, 1586)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `EthDispenser::DispenserConfig` (r:1 w:1)
	...
	fn unpause() -> Weight {
		...
		Weight::from_parts(17_331_000, 1586)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `EthDispenser::DispenserConfig` (r:1 w:1)
	...
	fn request_fund() -> Weight {
		...
		//  Measured:  `1806`
		//  Estimated: `8799`
		// Minimum execution time: 235_577_000 picoseconds.
		Weight::from_parts(238_017_000, 8799)
