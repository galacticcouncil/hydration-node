...
impl<T: frame_system::Config> pallet_dispenser::WeightInfo for HydraWeight<T> {
	...
	fn set_faucet_balance() -> Weight {
		...
		Weight::from_parts(13_125_000, 1501)
	...
	fn pause() -> Weight {
		...
		Weight::from_parts(13_745_000, 1486)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `EthDispenser::DispenserConfig` (r:1 w:1)
	...
	fn unpause() -> Weight {
		...
		Weight::from_parts(13_878_000, 1486)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn request_fund() -> Weight {
		...
		//  Measured:  `1759`
		//  Estimated: `8799`
		// Minimum execution time: 537_078_000 picoseconds.
		Weight::from_parts(541_027_000, 8799)
