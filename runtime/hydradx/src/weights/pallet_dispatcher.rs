...
impl<T: frame_system::Config> pallet_dispatcher::WeightInfo for HydraWeight<T> {
	...
	fn dispatch_as_treasury(n: u32, ) -> Weight {
		...
		Weight::from_parts(12_770_696, 0)
			// Standard Error: 1
	...
	fn dispatch_as_aave_manager(n: u32, ) -> Weight {
		...
		Weight::from_parts(13_616_870, 1517)
			// Standard Error: 1
	...
	fn dispatch_as_emergency_admin(n: u32, ) -> Weight {
		// Placeholder: uses dispatch_as_aave_manager weights until benchmarks are regenerated
		Weight::from_parts(13_616_870, 1517)
			// Standard Error: 1
			.saturating_add(Weight::from_parts(1_126, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn note_emergency_admin() -> Weight {
		// Placeholder: uses note_aave_manager weights until benchmarks are regenerated
		Weight::from_parts(4_624_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}