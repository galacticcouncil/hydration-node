...
impl<T: frame_system::Config> pallet_dispatcher::WeightInfo for HydraWeight<T> {
	...
	fn dispatch_as_aave_manager(n: u32, ) -> Weight {
		...
		Weight::from_parts(14_255_827, 1517)
			// Standard Error: 1
	...
	fn cleanup_on_idle(n: u32, ) -> Weight {
		...
		Weight::from_parts(25_000_000, 4651)
			// Standard Error: 902
			.saturating_add(Weight::from_parts(534_086, 0).saturating_mul(n.into()))
