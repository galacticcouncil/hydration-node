...
//! DATE: 2025-05-06, STEPS: `16`, REPEAT: `1`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_dispatcher::WeightInfo for HydraWeight<T> {
	...
	fn dispatch_as_treasury(n: u32, ) -> Weight {
		...
		Weight::from_parts(20_629_453, 0)
			// Standard Error: 69
			.saturating_add(Weight::from_parts(2_112, 0).saturating_mul(n.into()))
	}
	...
	fn dispatch_as_aave_manager(n: u32, ) -> Weight {
		...
		Weight::from_parts(24_231_348, 1517)
			// Standard Error: 72
			.saturating_add(Weight::from_parts(2_138, 0).saturating_mul(n.into()))
	...
	fn dispatch_with_extra_gas(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_970_427, 0)
			// Standard Error: 71
