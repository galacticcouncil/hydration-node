...
impl<T: frame_system::Config> pallet_route_executor::WeightInfo for HydraWeight<T> {
	...
	fn skip_ed_handling_for_trade_with_insufficient_assets() -> Weight {
		...
		Weight::from_parts(19_031_000, 3590)
	...
	fn calculate_and_execute_sell_in_lbp(c: u32, ) -> Weight {
		...
		//  Measured:  `3885`
		//  Estimated: `13905`
		// Minimum execution time: 426_949_000 picoseconds.
		Weight::from_parts(431_532_234, 13905)
			// Standard Error: 320_452
			.saturating_add(Weight::from_parts(77_319_165, 0).saturating_mul(c.into()))
	...
	fn calculate_and_execute_buy_in_lbp(c: u32, b: u32, ) -> Weight {
		...
		// Minimum execution time: 117_102_000 picoseconds.
		Weight::from_parts(118_360_000, 8799)
			// Standard Error: 238_682
			.saturating_add(Weight::from_parts(999_367, 0).saturating_mul(c.into()))
			// Standard Error: 531_612
			.saturating_add(Weight::from_parts(317_579_436, 0).saturating_mul(b.into()))
	...
	fn set_route_for_xyk() -> Weight {
		...
		//  Measured:  `7147`
		//  Estimated: `39735`
		// Minimum execution time: 2_409_233_000 picoseconds.
		Weight::from_parts(2_422_156_000, 39735)
	...
	fn get_route() -> Weight {
		...
		Weight::from_parts(9_645_000, 3555)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Oracles` (r:2 w:0)
	/// Proof: `EmaOracle::Oracles` (`max_values`: None, `max_size`: Some(177), added: 2652, mode: `MaxEncodedLen`)
	fn get_oracle_price_for_xyk() -> Weight {
		...
		Weight::from_parts(34_416_000, 6294)
	...
	fn get_oracle_price_for_omnipool() -> Weight {
		...
		Weight::from_parts(50_670_000, 11598)
	...
	fn calculate_spot_price_with_fee_in_lbp() -> Weight {
		...
		Weight::from_parts(59_930_000, 6190)
