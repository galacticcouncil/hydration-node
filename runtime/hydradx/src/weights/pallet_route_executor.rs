...
impl<T: frame_system::Config> pallet_route_executor::WeightInfo for HydraWeight<T> {
	...
	fn calculate_and_execute_sell_in_lbp(c: u32, ) -> Weight {
		...
		//  Measured:  `3535`
		//  Estimated: `13905`
		// Minimum execution time: 347_049_000 picoseconds.
		Weight::from_parts(350_762_308, 13905)
			// Standard Error: 214_404
			.saturating_add(Weight::from_parts(69_087_003, 0).saturating_mul(c.into()))
	...
	fn calculate_and_execute_buy_in_lbp(c: u32, b: u32, ) -> Weight {
		...
		// Minimum execution time: 94_096_000 picoseconds.
		Weight::from_parts(95_234_000, 6156)
			// Standard Error: 881_744
			.saturating_add(Weight::from_parts(3_499_280, 0).saturating_mul(c.into()))
			// Standard Error: 1_935_679
			.saturating_add(Weight::from_parts(266_101_120, 0).saturating_mul(b.into()))
