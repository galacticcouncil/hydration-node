...
impl<T: frame_system::Config> pallet_asset_registry::WeightInfo for HydraWeight<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(45_163_000, 4087)
	...
	fn update() -> Weight {
		...
		Weight::from_parts(47_191_000, 4087)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn register_external() -> Weight {
		...
		Weight::from_parts(34_101_000, 4087)
	...
	fn ban_asset() -> Weight {
		...
		Weight::from_parts(21_521_000, 3590)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn unban_asset() -> Weight {
		...
		Weight::from_parts(17_572_000, 3485)
