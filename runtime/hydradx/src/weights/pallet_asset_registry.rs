...
impl<T: frame_system::Config> pallet_asset_registry::WeightInfo for HydraWeight<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(45_600_000, 4087)
	...
	fn update() -> Weight {
		...
		//  Measured:  `650`
		//  Estimated: `4087`
		// Minimum execution time: 46_348_000 picoseconds.
		Weight::from_parts(46_874_000, 4087)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn register_external() -> Weight {
		...
		Weight::from_parts(33_699_000, 4087)
	...
	fn ban_asset() -> Weight {
		...
		Weight::from_parts(21_695_000, 3590)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn unban_asset() -> Weight {
		...
		Weight::from_parts(17_790_000, 3485)
