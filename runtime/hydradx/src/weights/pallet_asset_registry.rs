...
impl<T: frame_system::Config> pallet_asset_registry::WeightInfo for HydraWeight<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(43_658_000, 4087)
	...
	fn update() -> Weight {
		...
		Weight::from_parts(46_115_000, 4087)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn register_external() -> Weight {
		...
		Weight::from_parts(32_202_000, 4087)
	...
	fn ban_asset() -> Weight {
		...
		//  Measured:  `493`
		//  Estimated: `3590`
		// Minimum execution time: 20_332_000 picoseconds.
		Weight::from_parts(20_799_000, 3590)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn unban_asset() -> Weight {
		...
		Weight::from_parts(17_335_000, 3485)
