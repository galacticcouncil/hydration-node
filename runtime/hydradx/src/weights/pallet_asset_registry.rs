...
impl<T: frame_system::Config> pallet_asset_registry::WeightInfo for HydraWeight<T> {
	...
	fn register() -> Weight {
		...
		//  Measured:  `421`
		//  Estimated: `4087`
		// Minimum execution time: 44_496_000 picoseconds.
		Weight::from_parts(44_938_000, 4087)
	...
	fn update() -> Weight {
		...
		Weight::from_parts(47_093_000, 4087)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn register_external() -> Weight {
		...
		Weight::from_parts(33_785_000, 4087)
	...
	fn ban_asset() -> Weight {
		...
		Weight::from_parts(21_507_000, 3590)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn unban_asset() -> Weight {
		...
		Weight::from_parts(17_963_000, 3485)
