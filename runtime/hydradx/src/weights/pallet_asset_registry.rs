...
impl<T: frame_system::Config> pallet_asset_registry::WeightInfo for HydraWeight<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(45_905_000, 4087)
	...
	fn update() -> Weight {
		...
		Weight::from_parts(47_559_000, 4087)
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn register_external() -> Weight {
		...
		Weight::from_parts(33_831_000, 4087)
	...
	fn ban_asset() -> Weight {
		...
		Weight::from_parts(21_866_000, 3590)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn unban_asset() -> Weight {
		...
		Weight::from_parts(17_981_000, 3485)
