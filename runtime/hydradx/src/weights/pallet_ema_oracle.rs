...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		//  Measured:  `1872`
		//  Estimated: `2126`
		// Minimum execution time: 30_464_000 picoseconds.
		Weight::from_parts(30_889_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(48_020_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_832_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(23_857_632, 8086)
			// Standard Error: 25_666
			.saturating_add(Weight::from_parts(38_037_481, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_487_982, 8086)
			// Standard Error: 5_718
			.saturating_add(Weight::from_parts(645_233, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_417_326, 8086)
			// Standard Error: 5_344
			.saturating_add(Weight::from_parts(643_724, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_743_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		Weight::from_parts(57_969_000, 8086)
