...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_777_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(47_950_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_775_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		// Minimum execution time: 62_797_000 picoseconds.
		Weight::from_parts(25_400_534, 8086)
			// Standard Error: 22_977
			.saturating_add(Weight::from_parts(37_649_549, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_827_123, 8086)
			// Standard Error: 5_446
			.saturating_add(Weight::from_parts(650_356, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_049_897, 8086)
			// Standard Error: 5_595
			.saturating_add(Weight::from_parts(649_698, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_780_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		//  Measured:  `1858`
		//  Estimated: `8086`
		// Minimum execution time: 57_193_000 picoseconds.
		Weight::from_parts(57_727_000, 8086)
