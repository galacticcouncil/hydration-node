...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(31_469_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(48_989_000, 7406)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_937_000, 7406)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(5921), added: 6416, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(25_513_160, 7406)
			// Standard Error: 18_149
			.saturating_add(Weight::from_parts(37_247_446, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_663_611, 7406)
			// Standard Error: 5_808
			.saturating_add(Weight::from_parts(580_540, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_678_826, 7406)
			// Standard Error: 5_520
			.saturating_add(Weight::from_parts(588_827, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_760_000, 6294)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		//  Measured:  `1858`
		//  Estimated: `7406`
		// Minimum execution time: 58_767_000 picoseconds.
		Weight::from_parts(59_222_000, 7406)
