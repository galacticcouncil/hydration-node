...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_098_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(47_558_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_741_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		// Minimum execution time: 63_114_000 picoseconds.
		Weight::from_parts(26_354_960, 8086)
			// Standard Error: 18_027
			.saturating_add(Weight::from_parts(37_429_489, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_117_744, 8086)
			// Standard Error: 5_670
			.saturating_add(Weight::from_parts(632_201, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_890_832, 8086)
			// Standard Error: 5_284
			.saturating_add(Weight::from_parts(641_034, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		//  Measured:  `1546`
		//  Estimated: `6328`
		// Minimum execution time: 33_101_000 picoseconds.
		Weight::from_parts(33_680_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		Weight::from_parts(57_960_000, 8086)
