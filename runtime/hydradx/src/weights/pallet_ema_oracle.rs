...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		//  Measured:  `1872`
		//  Estimated: `2126`
		// Minimum execution time: 29_524_000 picoseconds.
		Weight::from_parts(29_999_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(48_472_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_685_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1195 + b * (891 ±0)`
		//  Estimated: `8086 + b * (8007 ±0)`
		// Minimum execution time: 74_080_000 picoseconds.
		Weight::from_parts(32_223_799, 8086)
			// Standard Error: 19_079
			.saturating_add(Weight::from_parts(42_980_904, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(35_808_121, 8086)
			// Standard Error: 5_266
			.saturating_add(Weight::from_parts(685_980, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(35_897_109, 8086)
			// Standard Error: 5_344
			.saturating_add(Weight::from_parts(684_032, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_314_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		Weight::from_parts(55_183_000, 8086)
