...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_831_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(48_587_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		//  Measured:  `742`
		//  Estimated: `8086`
		// Minimum execution time: 4_481_000 picoseconds.
		Weight::from_parts(4_587_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(25_547_842, 8086)
			// Standard Error: 15_550
			.saturating_add(Weight::from_parts(38_507_258, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		//  Estimated: `8086`
		// Minimum execution time: 35_778_000 picoseconds.
		Weight::from_parts(37_066_944, 8086)
			// Standard Error: 5_485
			.saturating_add(Weight::from_parts(558_551, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_133_804, 8086)
			// Standard Error: 5_427
			.saturating_add(Weight::from_parts(552_730, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_501_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		Weight::from_parts(58_239_000, 8086)
