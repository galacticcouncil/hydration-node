...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_105_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(47_664_000, 7406)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_744_000, 7406)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(5921), added: 6416, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(24_859_457, 7406)
			// Standard Error: 18_655
			.saturating_add(Weight::from_parts(36_887_775, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_091_623, 7406)
			// Standard Error: 5_410
			.saturating_add(Weight::from_parts(486_474, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_997_380, 7406)
			// Standard Error: 5_385
			.saturating_add(Weight::from_parts(495_666, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_425_000, 6294)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		//  Measured:  `1858`
		//  Estimated: `7406`
		// Minimum execution time: 57_264_000 picoseconds.
		Weight::from_parts(57_759_000, 7406)
