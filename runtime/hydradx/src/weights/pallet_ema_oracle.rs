...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_657_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(47_966_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_696_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		// Minimum execution time: 63_064_000 picoseconds.
		Weight::from_parts(22_846_723, 8086)
			// Standard Error: 17_170
			.saturating_add(Weight::from_parts(37_772_056, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		//  Estimated: `8086`
		// Minimum execution time: 35_983_000 picoseconds.
		Weight::from_parts(37_270_331, 8086)
			// Standard Error: 5_490
			.saturating_add(Weight::from_parts(641_177, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_491_249, 8086)
			// Standard Error: 5_491
			.saturating_add(Weight::from_parts(642_600, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(34_136_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		//  Measured:  `1858`
		//  Estimated: `8086`
		// Minimum execution time: 57_856_000 picoseconds.
		Weight::from_parts(58_578_000, 8086)
