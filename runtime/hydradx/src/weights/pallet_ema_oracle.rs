...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_735_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(47_782_000, 7406)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_833_000, 7406)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(5921), added: 6416, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		// Minimum execution time: 62_704_000 picoseconds.
		Weight::from_parts(26_107_265, 7406)
			// Standard Error: 16_438
			.saturating_add(Weight::from_parts(37_193_402, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1776 + b * (162 ±0)`
		//  Estimated: `7406`
		// Minimum execution time: 35_554_000 picoseconds.
		Weight::from_parts(36_999_304, 7406)
			// Standard Error: 5_235
			.saturating_add(Weight::from_parts(502_311, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(36_921_104, 7406)
			// Standard Error: 5_278
			.saturating_add(Weight::from_parts(503_477, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		Weight::from_parts(33_244_000, 6294)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		Weight::from_parts(57_849_000, 7406)
