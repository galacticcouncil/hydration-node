...
impl<T: frame_system::Config> pallet_ema_oracle::WeightInfo for HydraWeight<T> {
	...
	fn add_oracle() -> Weight {
		...
		Weight::from_parts(30_516_000, 2126)
	...
	fn remove_oracle() -> Weight {
		...
		Weight::from_parts(48_444_000, 8086)
	...
	fn on_finalize_no_entry() -> Weight {
		...
		Weight::from_parts(4_757_000, 8086)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `EmaOracle::Accumulator` (r:1 w:1)
	/// Proof: `EmaOracle::Accumulator` (`max_values`: Some(1), `max_size`: Some(6601), added: 7096, mode: `MaxEncodedLen`)
	...
	fn on_finalize_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(25_352_788, 8086)
			// Standard Error: 20_301
			.saturating_add(Weight::from_parts(38_020_299, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn on_trade_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_065_205, 8086)
			// Standard Error: 5_510
			.saturating_add(Weight::from_parts(650_404, 0).saturating_mul(b.into()))
	...
	fn on_liquidity_changed_multiple_tokens(b: u32, ) -> Weight {
		...
		Weight::from_parts(37_204_349, 8086)
			// Standard Error: 5_469
			.saturating_add(Weight::from_parts(648_050, 0).saturating_mul(b.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn get_entry() -> Weight {
		...
		//  Measured:  `1546`
		//  Estimated: `6328`
		// Minimum execution time: 33_407_000 picoseconds.
		Weight::from_parts(33_760_000, 6328)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn update_bifrost_oracle() -> Weight {
		...
		//  Measured:  `1858`
		//  Estimated: `8086`
		// Minimum execution time: 58_031_000 picoseconds.
		Weight::from_parts(58_446_000, 8086)
