...
impl<T: frame_system::Config> pallet_circuit_breaker::WeightInfo for HydraWeight<T> {
	...
	fn on_finalize(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 387_136_000 picoseconds.
		Weight::from_parts(389_299_000, 0)
			// Standard Error: 11_788
			.saturating_add(Weight::from_parts(344_595, 0).saturating_mul(n.into()))
			// Standard Error: 11_788
			.saturating_add(Weight::from_parts(1_266_833, 0).saturating_mul(m.into()))
	}
	...
	fn ensure_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(21_956_000, 3517)
	...
	fn ensure_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(19_280_000, 3517)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn ensure_pool_state_change_limit() -> Weight {
		...
		Weight::from_parts(19_703_000, 6076)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn lockdown_asset() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 10_113_000 picoseconds.
	...
	fn force_lift_lockdown() -> Weight {
		...
		Weight::from_parts(39_355_000, 3590)
	...
	fn release_deposit() -> Weight {
		...
		Weight::from_parts(53_695_000, 4726)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}