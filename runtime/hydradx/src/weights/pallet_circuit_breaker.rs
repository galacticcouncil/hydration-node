...
impl<T: frame_system::Config> pallet_circuit_breaker::WeightInfo for HydraWeight<T> {
	...
	fn on_finalize(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 394_523_000 picoseconds.
		Weight::from_parts(395_885_000, 0)
			// Standard Error: 11_968
			.saturating_add(Weight::from_parts(350_391, 0).saturating_mul(n.into()))
			// Standard Error: 11_968
			.saturating_add(Weight::from_parts(1_278_446, 0).saturating_mul(m.into()))
	}
	...
	fn ensure_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(22_388_000, 3517)
	...
	fn ensure_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(19_888_000, 3517)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn ensure_pool_state_change_limit() -> Weight {
		...
		Weight::from_parts(20_562_000, 6076)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
