...
impl<T: frame_system::Config> pallet_circuit_breaker::WeightInfo for HydraWeight<T> {
	...
	fn on_finalize(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 382_538_000 picoseconds.
		Weight::from_parts(385_301_000, 0)
			// Standard Error: 11_663
			.saturating_add(Weight::from_parts(336_397, 0).saturating_mul(n.into()))
			// Standard Error: 11_663
			.saturating_add(Weight::from_parts(1_232_926, 0).saturating_mul(m.into()))
	}
	...
	fn ensure_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(22_589_000, 3517)
	...
	fn ensure_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(20_096_000, 3517)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn ensure_pool_state_change_limit() -> Weight {
		...
		Weight::from_parts(20_397_000, 6076)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn force_lift_lockdown() -> Weight {
		...
		Weight::from_parts(39_654_000, 3590)
	...
	fn release_deposit() -> Weight {
		...
		//  Measured:  `1168`
		//  Estimated: `4726`
		// Minimum execution time: 52_815_000 picoseconds.
		Weight::from_parts(53_437_000, 4726)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}