...
impl<T: frame_system::Config> pallet_circuit_breaker::WeightInfo for HydraWeight<T> {
	...
	fn on_finalize(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 384_281_000 picoseconds.
		Weight::from_parts(386_945_000, 0)
			// Standard Error: 11_680
			.saturating_add(Weight::from_parts(338_630, 0).saturating_mul(n.into()))
			// Standard Error: 11_680
			.saturating_add(Weight::from_parts(1_253_264, 0).saturating_mul(m.into()))
	}
	...
	fn set_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(10_802_000, 0)
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn ensure_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(21_766_000, 3517)
	...
	fn ensure_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(19_514_000, 3517)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn ensure_pool_state_change_limit() -> Weight {
		...
		Weight::from_parts(20_344_000, 6076)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn force_lift_lockdown() -> Weight {
		...
		Weight::from_parts(36_128_000, 3590)
	...
	fn release_deposit() -> Weight {
		...
		//  Measured:  `1201`
		//  Estimated: `4726`
		// Minimum execution time: 48_935_000 picoseconds.
		Weight::from_parts(49_685_000, 4726)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}