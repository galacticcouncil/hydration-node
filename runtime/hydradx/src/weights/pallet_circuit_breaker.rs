...
impl<T: frame_system::Config> pallet_circuit_breaker::WeightInfo for HydraWeight<T> {
	...
	fn on_finalize(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 381_019_000 picoseconds.
		Weight::from_parts(384_153_000, 0)
			// Standard Error: 11_622
			.saturating_add(Weight::from_parts(340_108, 0).saturating_mul(n.into()))
			// Standard Error: 11_622
			.saturating_add(Weight::from_parts(1_222_045, 0).saturating_mul(m.into()))
	}
	...
	fn ensure_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(22_972_000, 3517)
	...
	fn ensure_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(19_376_000, 3517)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn ensure_pool_state_change_limit() -> Weight {
		...
		Weight::from_parts(19_540_000, 6076)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}