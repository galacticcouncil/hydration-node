...
impl<T: frame_system::Config> pallet_circuit_breaker::WeightInfo for HydraWeight<T> {
	...
	fn on_finalize(n: u32, m: u32, ) -> Weight {
		...
		//  Estimated: `0`
		// Minimum execution time: 387_215_000 picoseconds.
		Weight::from_parts(390_637_000, 0)
			// Standard Error: 11_788
			.saturating_add(Weight::from_parts(336_326, 0).saturating_mul(n.into()))
			// Standard Error: 11_788
			.saturating_add(Weight::from_parts(1_255_836, 0).saturating_mul(m.into()))
	}
	...
	fn set_remove_liquidity_limit() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 10_395_000 picoseconds.
	...
	fn ensure_add_liquidity_limit() -> Weight {
		...
		Weight::from_parts(22_059_000, 3517)
	...
	fn ensure_remove_liquidity_limit() -> Weight {
		...
		Weight::from_parts(19_400_000, 3517)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn ensure_pool_state_change_limit() -> Weight {
		...
		Weight::from_parts(19_767_000, 6076)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}