...
//! DATE: 2024-06-18, STEPS: `10`, REPEAT: `30`, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> pallet_route_executor::weights::WeightInfo for HydraWeight<T> {
	...
	fn calculate_and_execute_sell_in_lbp(c: u32, ) -> Weight {
		...
		//  Measured:  `3535`
		//  Estimated: `13905`
		// Minimum execution time: 331_742_000 picoseconds.
		Weight::from_parts(334_752_338, 13905)
			// Standard Error: 172_616
			.saturating_add(Weight::from_parts(53_146_599, 0).saturating_mul(c.into()))
	...
	fn calculate_and_execute_buy_in_lbp(c: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(74_850_000, 6156)
			// Standard Error: 595_333
			.saturating_add(Weight::from_parts(2_341_575, 0).saturating_mul(c.into()))
			// Standard Error: 1_306_926
			.saturating_add(Weight::from_parts(268_504_139, 0).saturating_mul(b.into()))
	...
	fn set_route_for_xyk() -> Weight {
		...
		//  Measured:  `6426`
		//  Estimated: `39735`
		// Minimum execution time: 2_128_339_000 picoseconds.
		Weight::from_parts(2_136_391_000, 39735)
