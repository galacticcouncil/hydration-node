...
impl<T: frame_system::Config> pallet_route_executor::weights::WeightInfo for HydraWeight<T> {
	...
	fn skip_ed_handling_for_trade_with_insufficient_assets() -> Weight {
		...
		Weight::from_parts(13_800_000, 3590)
	...
	fn calculate_and_execute_sell_in_lbp(c: u32, ) -> Weight {
		...
		//  Measured:  `3743`
		//  Estimated: `13905`
		// Minimum execution time: 278_147_000 picoseconds.
		Weight::from_parts(283_135_382, 13905)
			// Standard Error: 216_715
			.saturating_add(Weight::from_parts(36_755_305, 0).saturating_mul(c.into()))
	...
	fn calculate_and_execute_buy_in_lbp(c: u32, b: u32, ) -> Weight {
		...
		Weight::from_parts(54_319_000, 6156)
			// Standard Error: 448_534
			.saturating_add(Weight::from_parts(1_926_964, 0).saturating_mul(c.into()))
			// Standard Error: 984_662
			.saturating_add(Weight::from_parts(234_713_789, 0).saturating_mul(b.into()))
	...
	fn set_route_for_xyk() -> Weight {
		...
		//  Measured:  `6426`
		//  Estimated: `39735`
		// Minimum execution time: 2_067_490_000 picoseconds.
		Weight::from_parts(2_082_989_000, 39735)
