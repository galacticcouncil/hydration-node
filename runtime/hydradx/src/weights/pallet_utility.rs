...
impl<T: frame_system::Config> pallet_utility::WeightInfo for HydraWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_162_210, 1489)
			// Standard Error: 3_186
			.saturating_add(Weight::from_parts(4_310_187, 0).saturating_mul(c.into()))
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(9_204_924, 1489)
			// Standard Error: 3_802
			.saturating_add(Weight::from_parts(4_593_382, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	fn dispatch_as() -> Weight {
		...
		Weight::from_parts(11_093_000, 0)
	}
	/// Storage: `Broadcast::IncrementalId` (r:1 w:1)
	/// Proof: `Broadcast::IncrementalId` (`max_values`: Some(1), `max_size`: Some(4), added: 499, mode: `MaxEncodedLen`)
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(11_213_058, 1489)
			// Standard Error: 3_081
			.saturating_add(Weight::from_parts(4_304_443, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}