...
impl<T: frame_system::Config> pallet_migrations::WeightInfo for HydraWeight<T> {
	...
	fn onboard_new_mbms() -> Weight {
		...
		Weight::from_parts(11_534_000, 67035)
	...
	fn progress_mbms_none() -> Weight {
		...
		Weight::from_parts(3_692_000, 67035)
	...
	fn exec_migration_completed() -> Weight {
		...
		Weight::from_parts(9_109_000, 3494)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_skipped_historic() -> Weight {
		...
		Weight::from_parts(16_546_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_advance() -> Weight {
		...
		Weight::from_parts(16_234_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_complete() -> Weight {
		...
		Weight::from_parts(18_524_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(25_988_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn force_onboard_mbms() -> Weight {
		...
		Weight::from_parts(9_472_000, 67035)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(17_744_960, 3834)
			// Standard Error: 2_115
			.saturating_add(Weight::from_parts(1_256_000, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		Weight::from_parts(25_541_114, 787)
			// Standard Error: 1_703
			.saturating_add(Weight::from_parts(750_053, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
