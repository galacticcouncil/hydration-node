...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for HydraWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(27_958_000, 3550)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(7_175_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(17_040_000, 3550)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		//  Measured:  `217`
		//  Estimated: `3682`
		// Minimum execution time: 83_061_000 picoseconds.
		Weight::from_parts(83_904_000, 3682)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(17_418_000, 3550)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(85), added: 2560, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `106`
		//  Estimated: `3571`
		// Minimum execution time: 83_316_000 picoseconds.
		Weight::from_parts(83_959_000, 3571)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		...
		Weight::from_parts(8_406_000, 3793)
			// Standard Error: 12
			.saturating_add(Weight::from_parts(1_953, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
