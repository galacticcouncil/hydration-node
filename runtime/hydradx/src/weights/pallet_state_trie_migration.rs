...
impl<T: frame_system::Config> pallet_state_trie_migration::WeightInfo for HydraWeight<T> {
	...
	fn continue_migrate() -> Weight {
		...
		Weight::from_parts(28_017_000, 3604)
	...
	fn continue_migrate_wrong_witness() -> Weight {
		...
		Weight::from_parts(7_412_000, 1493)
	...
	fn migrate_custom_top_success() -> Weight {
		...
		Weight::from_parts(17_676_000, 3604)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn migrate_custom_top_fail() -> Weight {
		...
		//  Measured:  `250`
		//  Estimated: `3715`
		// Minimum execution time: 89_034_000 picoseconds.
		Weight::from_parts(89_716_000, 3715)
	...
	fn migrate_custom_child_success() -> Weight {
		...
		Weight::from_parts(18_147_000, 3604)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Balances::Holds` (r:1 w:1)
	/// Proof: `Balances::Holds` (`max_values`: None, `max_size`: Some(139), added: 2614, mode: `MaxEncodedLen`)
	...
	fn migrate_custom_child_fail() -> Weight {
		...
		//  Measured:  `106`
		//  Estimated: `3604`
		// Minimum execution time: 86_475_000 picoseconds.
		Weight::from_parts(87_079_000, 3604)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn process_top_key(v: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `219 + v * (1 ±0)`
		//  Estimated: `3684 + v * (1 ±0)`
		// Minimum execution time: 7_179_000 picoseconds.
		Weight::from_parts(7_324_000, 3684)
			// Standard Error: 19
			.saturating_add(Weight::from_parts(2_295, 0).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
