...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
    ...
    fn retract_tip() -> Weight {
        ...
        Weight::from_ref_time(15_230_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(2 as u64))
    }
    ...
    fn slash_tip(_t: u32, ) -> Weight {
        ...
        Weight::from_ref_time(10_233_413 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(2 as u64))
    }
}
