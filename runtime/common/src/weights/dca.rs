...
//! DATE: 2023-05-19, STEPS: 5, REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	fn on_initialize_with_one_trade() -> Weight {
		Weight::from_ref_time(309_897_000 as u64)
	...
	fn on_initialize_with_empty_block() -> Weight {
		Weight::from_ref_time(9_910_000 as u64).saturating_add(T::DbWeight::get().reads(2 as u64))
	}
	fn schedule() -> Weight {
		Weight::from_ref_time(118_229_000 as u64)
			.saturating_add(T::DbWeight::get().reads(11 as u64))
			.saturating_add(T::DbWeight::get().writes(8 as u64))
	}
	fn terminate() -> Weight {
		Weight::from_ref_time(64_920_000 as u64)
