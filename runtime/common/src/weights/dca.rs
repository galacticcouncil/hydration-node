...
//! DATE: 2023-05-24, STEPS: 5, REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	fn on_initialize_with_one_trade() -> Weight {
		Weight::from_ref_time(331_117_000 as u64)
	...
	fn on_initialize_with_empty_block() -> Weight {
		Weight::from_ref_time(8_980_000 as u64).saturating_add(T::DbWeight::get().reads(2 as u64))
	}
	fn schedule() -> Weight {
		Weight::from_ref_time(116_339_000 as u64)
			.saturating_add(T::DbWeight::get().reads(14 as u64))
			.saturating_add(T::DbWeight::get().writes(8 as u64))
	}
	fn terminate() -> Weight {
		Weight::from_ref_time(60_789_000 as u64)
