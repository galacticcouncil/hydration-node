...
//! DATE: 2023-05-29, STEPS: 5, REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	...
	fn on_initialize_with_buy_trade() -> Weight {
		// Minimum execution time: 340_829 nanoseconds.
		Weight::from_ref_time(343_778_000 as u64)
	...
	fn on_initialize_with_sell_trade() -> Weight {
		// Minimum execution time: 323_648 nanoseconds.
		Weight::from_ref_time(328_318_000 as u64)
			.saturating_add(T::DbWeight::get().reads(28 as u64))
			.saturating_add(T::DbWeight::get().writes(17 as u64))
	}
	// Storage: RelayChainInfo ParentHash (r:1 w:0)
	...
	fn on_initialize_with_empty_block() -> Weight {
		...
		Weight::from_ref_time(7_400_000 as u64).saturating_add(T::DbWeight::get().reads(2 as u64))
	}
	...
	// Proof: DCA ScheduleOwnership (max_values: None, max_size: Some(60), added: 2535, mode: MaxEncodedLen)
	fn terminate() -> Weight {
		// Minimum execution time: 47_600 nanoseconds.
