...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	...
	fn set_storage(i: u32) -> Weight {
		(97_000 as Weight) // Standard Error: 1_000
			.saturating_add((522_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(i as Weight)))
	}
	fn kill_storage(i: u32) -> Weight {
		(1_558_000 as Weight) // Standard Error: 1_000
			.saturating_add((376_000 as Weight).saturating_mul(i as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(i as Weight)))
	}
	fn kill_prefix(p: u32) -> Weight {
		(3_308_000 as Weight) // Standard Error: 1_000
