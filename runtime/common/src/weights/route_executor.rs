...
//! DATE: 2023-05-26, STEPS: 5, REPEAT: 20, LOW RANGE: [], HIGH RANGE: []
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
	...
	fn sell(n: u32) -> Weight {
		// Minimum execution time: 192_649 nanoseconds.
		Weight::from_ref_time(195_878_500 as u64) // Standard Error: 427_785
			.saturating_add(Weight::from_ref_time(994_250 as u64).saturating_mul(n as u64))
	...
	/// The range of component `n` is `[1, 2]`.
	fn buy(n: u32) -> Weight {
		// Minimum execution time: 189_879 nanoseconds.
		Weight::from_ref_time(194_125_600 as u64) // Standard Error: 200_645
			.saturating_add(Weight::from_ref_time(583_150 as u64).saturating_mul(n as u64))
			.saturating_add(T::DbWeight::get().reads(16 as u64))
			.saturating_add(T::DbWeight::get().writes(12 as u64))
	}
}
