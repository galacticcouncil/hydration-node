...
use pallet_claims::weights::WeightInfo;
...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
    ...
    fn claim() -> Weight {
        // Minimum execution time: 58_490 nanoseconds.
        Weight::from_ref_time(59_068_000 as u64)            .saturating_add(T::DbWeight::get().reads(2 as u64))
