...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
    ...
    fn set_config_with_u32() -> Weight {
        ...
        Weight::from_ref_time(8_353_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
    ...
    fn set_config_with_weight() -> Weight {
        ...
        Weight::from_ref_time(8_614_000 as u64)            .saturating_add(T::DbWeight::get().reads(1 as u64))
            .saturating_add(T::DbWeight::get().writes(1 as u64))
    }
}
