...
impl<T: frame_system::Config> WeightInfo for HydraWeight<T> {
    ...
    fn create_global_farm() -> Weight {
        ...
        Weight::from_ref_time(77_367_000 as u64)            .saturating_add(T::DbWeight::get().reads(5 as u64))
    ...
    fn terminate_global_farm() -> Weight {
        ...
        Weight::from_ref_time(74_244_000 as u64)            .saturating_add(T::DbWeight::get().reads(4 as u64))
    ...
    fn create_yield_farm() -> Weight {
        ...
        Weight::from_ref_time(113_046_000 as u64)            .saturating_add(T::DbWeight::get().reads(9 as u64))
    ...
    fn update_yield_farm() -> Weight {
        ...
        Weight::from_ref_time(116_403_000 as u64)            .saturating_add(T::DbWeight::get().reads(9 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
	// Storage: OmnipoolWarehouseLM ActiveYieldFarm (r:1 w:1)
	// Proof: OmnipoolWarehouseLM ActiveYieldFarm (max_values: None, max_size: Some(44), added: 2519, mode: MaxEncodedLen)
    ...
    fn stop_yield_farm() -> Weight {
        ...
        Weight::from_ref_time(110_747_000 as u64)            .saturating_add(T::DbWeight::get().reads(8 as u64))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
	// Storage: Omnipool Assets (r:1 w:0)
	// Proof: Omnipool Assets (max_values: None, max_size: Some(85), added: 2560, mode: MaxEncodedLen)
    ...
    fn resume_yield_farm() -> Weight {
        ...
        Weight::from_ref_time(112_560_000 as u64)            .saturating_add(T::DbWeight::get().reads(9 as u64))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
	// Storage: OmnipoolWarehouseLM ActiveYieldFarm (r:1 w:0)
	// Proof: OmnipoolWarehouseLM ActiveYieldFarm (max_values: None, max_size: Some(44), added: 2519, mode: MaxEncodedLen)
    ...
    fn terminate_yield_farm() -> Weight {
        ...
        Weight::from_ref_time(63_833_000 as u64)            .saturating_add(T::DbWeight::get().reads(5 as u64))
            .saturating_add(T::DbWeight::get().writes(4 as u64))
    }
    ...
    fn deposit_shares() -> Weight {
        ...
        Weight::from_ref_time(205_504_000 as u64)            .saturating_add(T::DbWeight::get().reads(17 as u64))
    ...
    fn redeposit_shares() -> Weight {
        ...
        Weight::from_ref_time(166_680_000 as u64)            .saturating_add(T::DbWeight::get().reads(15 as u64))
            .saturating_add(T::DbWeight::get().writes(5 as u64))
    }
    ...
    fn claim_rewards() -> Weight {
        ...
        Weight::from_ref_time(142_769_000 as u64)            .saturating_add(T::DbWeight::get().reads(10 as u64))
            .saturating_add(T::DbWeight::get().writes(6 as u64))
    }
	// Storage: Uniques Asset (r:2 w:2)
	// Proof: Uniques Asset (max_values: None, max_size: Some(146), added: 2621, mode: MaxEncodedLen)
    ...
    fn withdraw_shares() -> Weight {
        ...
        Weight::from_ref_time(238_415_000 as u64)            .saturating_add(T::DbWeight::get().reads(15 as u64))
